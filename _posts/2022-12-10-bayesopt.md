...
![1_BDhUV6VLxZRZ7ue-wPPOlw.gif](/assets/blogs/2022-12-10-bayesopt/1_BDhUV6VLxZRZ7ue-wPPOlw.gif)
...
![Untitled](/assets/blogs/2022-12-10-bayesopt/Untitled.png)
...
![Untitled](/assets/blogs/2022-12-10-bayesopt/Untitled%201.png)
...
- **Observation model**: conduct observation (alternative function) at point $$x$$ to guide the search for optimal point $$x^*$$ of $$f$$. As $$f$$ cannot be observed directly and noises (imperfect stimulation, statistical approximation,$$\cdots$$) prevent the observation from yielding the exact value, we made an *assumption* that the observation model follows a [stochastic mechanism](https://en.wikipedia.org/wiki/Stochastic_process) depending on $$f$$.
  <!-- - Specifically, given $$\phi = f(x)$$, the measured value $$y$$ results from the observation on $$x$$ is *distributed* according to an observation model on $$\phi$$. One particular observation model is *additive Gaussian noise*, where $$y = \phi + \varepsilon$$ follow the Gaussian distribution, with $$\varepsilon$$ represents measurement error: -->
    ...
    <!-- ![Untitled](/assets/blogs/2022-12-10-bayesopt/Untitled%202.png) -->
...
![Untitled](/assets/blogs/2022-12-10-bayesopt/Untitled%203.png)
...
![Untitled](/assets/blogs/2022-12-10-bayesopt/Untitled%204.png)
...
![Untitled](/assets/blogs/2022-12-10-bayesopt/Untitled%2013.png)
...
![](/assets/blogs/2022-12-10-bayesopt/E2bRdhkXwAA478n.gif)
...
![Untitled](/assets/blogs/2022-12-10-bayesopt/Untitled%207.png)
...
![The surrogate model with 95% credible interval at point $$x$$](/assets/blogs/2022-12-10-bayesopt/Untitled%208.png)
...
![Untitled](/assets/blogs/2022-12-10-bayesopt/Untitled%209.png)
...
![Exploitation (high mean) and Exploration (high variance) approaches for acquisition value in sampling the next observed value.](/assets/blogs/2022-12-10-bayesopt/gp_model_with_one_more_point.png)
...
![](/assets/blogs/2022-12-10-bayesopt/Untitled%2010.png)
...
![Untitled](/assets/blogs/2022-12-10-bayesopt/Untitled%2011.png)
...
![Untitled](/assets/blogs/2022-12-10-bayesopt/Untitled%2012.png)
...
![Untitled](/assets/blogs/2022-12-10-bayesopt/Untitled%206.png)
...
+ My [**presentation slide**](/assets/blogs/2022-12-10-bayesopt/BayesOpt_slide.pdf) for this writing blog.
